...
verb in the topic. For Host Applications, the spCv4.0/STATE/sparkplug_host_id topic is used. More
...
Host Applications, the spCv4.0/STATE/sparkplug_host_id topic is used. More details and requirements
